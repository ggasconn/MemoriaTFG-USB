...
Este capítulo sirve de introducción al protocolo de comunicación USB, donde se 



Este capítulo consta de una introducción general al protocolo de comunicación USB, así como su implementación en Linux y los detalles a más bajo nivel que forman parte de esta implementación. se detalla a modo de introducción el funcionamiento a bajo nivel del protocolo USB, los tipos de mensajes que se envían entre el host y dispositivo; y los diferentes extremos de comunicación con los que se cuentan (endpoints), así como el protocolo HID utilizado en el proyecto. También se explica un ejemplo de uso del driver para el Blinkstick utilizado en la asignatura Arquitectura interna de Linux y Android.
